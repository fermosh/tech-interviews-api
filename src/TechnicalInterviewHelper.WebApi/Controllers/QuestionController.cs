    ...
    public class QuestionController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Post(IEnumerable<Question> questions)
        {
            ...
            questions.ToList().ForEach(q => {
                q.DocumentTypeId = DocumentType.Questions;
                q.Id = string.Empty;    // For inserting/creating a question the Id is generated by DocumentDb. Ignore the Id provided by the user.
            });
